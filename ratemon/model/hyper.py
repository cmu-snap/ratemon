...
def main():
    ...
    psr = argparse.ArgumentParser(description="Hyper-parameter optimizer for train.py.")
    ...
    psr.add_argument(
        ...
        action="store_true",
        help=(
            "Try all combinations of parameters. Incompatible with "
    ...
    params = [
        {"name": "data_dir", "type": "fixed", "value": args.data_dir},
        {"name": "model", "type": "choice", "values": ["SvmSklearn", "LrSklearn"]},
        {"name": "conf_trials", "type": "fixed", "value": tls_cnf},
        {"name": "max_attempts", "type": "fixed", "value": args.max_attempts},
        {"name": "num_gpus", "type": "fixed", "value": 0},
        {"name": "warmup_percent", "type": "fixed", "value": 10},
        {"name": "num_sims", "type": "fixed", "value": args.num_sims},
        # {
        #     "name": "train_batch",
        #     "type": "fixed",
        #     "value": 10
        ...
        {"name": "degree", "type": "choice", "values": list(range(0, 21))},
        {"name": "penalty", "type": "choice", "values": ["l1", "l2"]},
        {"name": "no_rand", "type": "fixed", "value": no_rand},
        {"name": "timeout_s", "type": "fixed", "value": args.timeout_s},
        {"name": "out_dir", "type": "fixed", "value": args.out_dir},
    ]
    ...
    if args.early_stop:
        params.extend(
            [
                {"name": "early_stop", "type": "fixed", "value": True},
                {"name": "val_patience", "type": "range", "bounds": [5, 20]},
                {
    ...
    if args.exhaustive:
        ...
        print(
            (
                f"Running {tls_opt} optimization trial(s), with {tls_cnf} "
    ...
    print(
        (
            f"Done with hyper-parameter optimization - "
