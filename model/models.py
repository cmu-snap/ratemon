...
class SvmSklearnWrapper(SvmWrapper):
    ...
    in_spc = [
        ...
        "throughput ewma-alpha0.1",
        "throughput ewma-alpha0.2",
        "throughput ewma-alpha0.3",
        "throughput ewma-alpha0.4",
        "throughput ewma-alpha0.5",
        "throughput ewma-alpha0.6",
        "throughput ewma-alpha0.7",
        "throughput ewma-alpha0.8",
        "throughput ewma-alpha0.9",
        "throughput ewma-alpha1.0",
        ...
        "average throughput windowed-minRtt1",
        "average throughput windowed-minRtt2",
        "average throughput windowed-minRtt4",
        "average throughput windowed-minRtt8",
        "average throughput windowed-minRtt16",
        "average throughput windowed-minRtt32",
        "average throughput windowed-minRtt64",
        "average throughput windowed-minRtt128",
        "average throughput windowed-minRtt256",
        "average throughput windowed-minRtt512",
        "average throughput windowed-minRtt1024",
